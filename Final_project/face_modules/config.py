...
# Threshold values
FACE_RECOGNITION_THRESHOLD = 0.5  # Threshold for face recognition (adjusted for normalized embeddings)
EYE_ASPECT_RATIO_THRESHOLD = 0.25  # Threshold for detecting open/closed eyes

# Model paths
import os
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
FACE_EMBEDDING_MODEL_PATH = os.path.join(BASE_DIR, 'model_factory', 'embedding_euclidean.keras')
